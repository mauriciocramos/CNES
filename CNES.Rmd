---
title: "CNES - Brazilian National Register of Health Establishments"
...
<!-- TP_PFPJ (1-FISICA, 3-JURIDICA) -->
<!-- NIVEL_DEP (1-INDIVIDUAL, 3-MANTIDO) -->
<!-- NO_RAZAO_SOCIAL -->
<!-- NO_FANTASIA -->
<!-- NO_LOGRADOURO -->
<!-- NU_ENDERECO -->
...
<!-- NU_CNPJ -->
<!-- DT_EXPEDICAO -->
<!-- TP_ORGAO_EXPEDIDOR (1-SES, 2-SMS) -->
<!-- DT_VAL_LIC_SANI -->
<!-- TP_UNIDADE (TB_TIPO_UNIDADE) -->
<!-- CO_ESTADO_GESTOR -->
<!-- CO_MUNICIPIO_GESTOR (TB_MUNICIPIO) -->
<!-- DT_ATUALIZACAO -->
<!-- CO_CPFDIRETORCLN -->
<!-- REG_DIRETORCLN -->
<!-- ST_ADESAO_ FILANTROP (1-SIM, 2-NAO) -->
<!-- CO_MOTIVO_DESAB (TB_MOTIVO_DESATIVACAO) -->
<!-- NO_URL -->
<!-- NU_LATITUDE -->
<!-- NU_LONGITUDE -->
<!-- DT_ATU_GEO -->
<!-- CO_NATUREZA_JUR (TB_NATUREZA_JURIDICA) -->
<!-- TP_ESTAB_SEMPRE_ABERTO (S-SIM, N-NAO) -->
<!-- ST_GERACREDITO_GERENTE_SGIF (S-SIM, N-NAO) -->
<!-- TP_GESTAO (M-MUNICIPAL, E-ESTADUAL, D-DUPLA, S-SEM GESTAO) -->
...
## Geo-referenced health establishments
